...
public static class CourseSeedData
{
    ...
    private static List<Course> GetCourses()
    {
        ...
        course1.Schedule("Fall 2026", 2026, new DateTime(2026, 8, 24, 0, 0, 0, DateTimeKind.Utc), new DateTime(2026, 12, 13, 0, 0, 0, DateTimeKind.Utc));
        course1.Activate();
        courses.Add(course1);
        ...
        course2.Schedule("Fall 2026", 2026, new DateTime(2026, 8, 24, 0, 0, 0, DateTimeKind.Utc), new DateTime(2026, 12, 13, 0, 0, 0, DateTimeKind.Utc));
        course2.Activate();
        courses.Add(course2);
        ...
        course3.Schedule("Spring 2027", 2027, new DateTime(2027, 1, 18, 0, 0, 0, DateTimeKind.Utc), new DateTime(2027, 5, 8, 0, 0, 0, DateTimeKind.Utc));
        course3.Activate();
        courses.Add(course3);
        ...
        course4.Schedule("Fall 2026", 2026, new DateTime(2026, 8, 24, 0, 0, 0, DateTimeKind.Utc), new DateTime(2026, 12, 13, 0, 0, 0, DateTimeKind.Utc));
        course4.Activate();
        courses.Add(course4);
        ...
        course5.Schedule("Fall 2026", 2026, new DateTime(2026, 8, 24, 0, 0, 0, DateTimeKind.Utc), new DateTime(2026, 12, 13, 0, 0, 0, DateTimeKind.Utc));
        course5.Activate();
        courses.Add(course5);
        ...
        course6.Schedule("Spring 2027", 2027, new DateTime(2027, 1, 18, 0, 0, 0, DateTimeKind.Utc), new DateTime(2027, 5, 8, 0, 0, 0, DateTimeKind.Utc));
        course6.Activate();
        courses.Add(course6);
