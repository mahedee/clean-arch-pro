...
public static class TeacherSeedData
{
    ...
    private static List<Teacher> GetTeachers()
    {
        ...
        var teacher1 = Teacher.Create(
            ...
            new DateTime(1975, 3, 22, 0, 0, 0, DateTimeKind.Utc)
        );
        ...
        var teacher2 = Teacher.Create(
            ...
            new DateTime(1980, 7, 14, 0, 0, 0, DateTimeKind.Utc)
        );
        ...
        var teacher3 = Teacher.Create(
            ...
            new DateTime(1985, 11, 8, 0, 0, 0, DateTimeKind.Utc)
        );
        ...
        var teacher4 = Teacher.Create(
            ...
            "Physics",
            AcademicTitle.Professor,
            new DateTime(1972, 12, 3, 0, 0, 0, DateTimeKind.Utc)
        );
        ...
        var teacher5 = Teacher.Create(
            ...
            "Computer Science",
            AcademicTitle.Professor,
            new DateTime(1970, 5, 15, 0, 0, 0, DateTimeKind.Utc)
        );
