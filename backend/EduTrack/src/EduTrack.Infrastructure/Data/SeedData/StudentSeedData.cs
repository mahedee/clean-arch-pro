...
public static class StudentSeedData
{
    ...
    private static List<Student> GetStudents()
    {
        ...
        var student1 = Student.Create(
            "John Michael Smith",
            new DateTime(1998, 5, 15, 0, 0, 0, DateTimeKind.Utc),
        ...
        var student2 = Student.Create(
            ...
            new DateTime(1999, 3, 22, 0, 0, 0, DateTimeKind.Utc),
        ...
        var student3 = Student.Create(
            ...
            new DateTime(1997, 11, 8, 0, 0, 0, DateTimeKind.Utc),
        ...
        var student4 = Student.Create(
            "Emily Rose Wilson", 
            new DateTime(2000, 7, 14, 0, 0, 0, DateTimeKind.Utc),
        ...
        var student5 = Student.Create(
            "David Anthony Brown",
            new DateTime(1999, 12, 3, 0, 0, 0, DateTimeKind.Utc),
