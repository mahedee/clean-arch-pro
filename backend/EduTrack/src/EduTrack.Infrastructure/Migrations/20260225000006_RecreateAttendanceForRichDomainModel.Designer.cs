...
namespace EduTrack.Infrastructure.Migrations
{
    ...
    [Migration("20260225000006_RecreateAttendanceForRichDomainModel")]
    partial class RecreateAttendanceForRichDomainModel
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("EduTrack.Domain.Entities.Teacher", b =>
                {
                    ...
                    b.Property<int>("CurrentCourseLoad")
                        .HasColumnType("integer");
                    ...
                    b.Property<int>("MaxCoursesPerSemester")
                        .HasColumnType("integer");
