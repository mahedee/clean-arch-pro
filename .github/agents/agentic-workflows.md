...
---
{
  "name": "edu-track",
  "metadata": {
    "description": "GitHub Copilot plugins for the EduTrack education management system — Clean Architecture, .NET 10, Angular, and PostgreSQL workflows.",
    "version": "1.0.0"
  },
  "owner": {
    "name": "Mahedee Hasan",
  ...
  "plugins": [
    {
      "name": "edutrack-clean-arch",
      "source": ".github/plugins/clean-arch",
      "description": "Clean Architecture + DDD + CQRS coding agent for EduTrack. Enforces MediatR commands/queries, Repository + Unit of Work patterns, FluentValidation, and AutoMapper conventions.",
      "version": "1.0.0"
    },
    {
      "name": "edutrack-backend",
      "source": ".github/plugins/backend",
      "description": "ASP.NET Core 10 API development skills for EduTrack — endpoint scaffolding, Swagger/OpenAPI, structured Serilog logging, and EF Core PostgreSQL migrations.",
      "version": "1.0.0"
    },
    {
      "name": "edutrack-frontend",
      "source": ".github/plugins/frontend",
      "description": "Angular 18 + Angular Material development skills for the EduTrack UI — component generation, reactive forms, RxJS patterns, and API integration.",
      "version": "1.0.0"
    },
    {
      "name": "edutrack-testing",
      "source": ".github/plugins/testing",
      "description": "xUnit + Moq + FluentAssertions test generation for EduTrack — domain unit tests, application handler tests, and integration test scaffolding.",
      "version": "1.0.0"
    }
  ]
}
