      ...
      <mat-card-content>
        ...
        <div class="filters-section">
          <mat-form-field appearance="outline">
            ...
            <input matInput 
                   [(ngModel)]="searchQuery.searchTerm" 
          ...
          <div class="filter-actions">
            ...
            <button mat-raised-button color="primary" (click)="loadStudents()">Search</button>
          </div>
        </div>
        ...
        <div class="table-container" *ngIf="!isLoading">
          ...
          <!-- No Data Message -->
          <div *ngIf="students.length === 0 && !isLoading" class="no-data">
          ...
          <!-- Pagination -->
          <mat-paginator 
            *ngIf="paginationData && paginationData.totalCount > 0"
            [length]="paginationData.totalCount"
            [pageSize]="paginationData.pageSize"
            [pageIndex]="paginationData.pageNumber - 1"
  ...
  loadStudents(): void {
    ...
    this.studentService.getStudents(this.searchQuery).subscribe({
      next: (response) => {
        ...
        this.students = response.students || response.data || [];
